...
describe('classic-og-v0.7-a hideout foundation', () => {
  ...
  it('keeps the 0.7-G hideout extension active in 0.7-I', () => {
    expect(classicOgV07I.hideout).toEqual(classicOgV07H.hideout);
    expect(hideoutV2For(classicOgV07I)).toEqual(hideoutV2For(classicOgV07G));
    expect(hideoutV2Problems(classicOgV07I)).toEqual([]);
  });
