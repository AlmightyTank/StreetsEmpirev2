...
export const classicOgV06A = {
  ...
  turf: {
    districts: {
      CASINO: { holdBonus: 1.15, taxBurn: 0.12, taxMint: 0.07, cornerMinimum: 8, localsThugs: 30 },
      NIGHTCLUB: { holdBonus: 1.12, taxBurn: 0.1, taxMint: 0.06, cornerMinimum: 6, localsThugs: 22 },
      LOW_RENT: { holdBonus: 1.1, taxBurn: 0.08, taxMint: 0.05, cornerMinimum: 4, localsThugs: 12 },
      URBAN_GHETTO: { holdBonus: 1.1, taxBurn: 0.08, taxMint: 0.05, cornerMinimum: 4, localsThugs: 14 },
      WINO_SLUMS: { holdBonus: 1.08, taxBurn: 0.06, taxMint: 0.04, cornerMinimum: 3, localsThugs: 8 },
    },
    locals: {
      byCity: {
        'detroit': 1.4,
