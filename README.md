...
| **0.3.0-C** | alliances: membership with an atomic size cap, alliance page and rankings, tags, no friendly fire, shared revenge, leave cooldown, admin rename and disband | **core implemented; forum and Discord hooks next** |
