...
city map. 0.6.0-B has started with Scout presence written and read from the turf map;
claiming, posting, tax, upkeep and pushes are still planned. Decisions marked *(proposed)*
are open until the 0.5.0 public round reports in.
