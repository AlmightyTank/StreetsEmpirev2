...
Status: **0.2.0-H raid trophies started.** Reputation is
...
and F pins the first production-facing public raid round plus drug-hoe, ride-theft and crew-lure raid forms at `0.2.0-F.2`. G inherits that balance at `0.2.0-G.1` and starts player-facing clarity work. H inherits G at `0.2.0-H.1` and starts trophies for the expanded raid forms.
