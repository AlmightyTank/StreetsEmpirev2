...
export const NotificationService = {
  ...
  async claimDiscord(prisma: PrismaClient, now = new Date(), limit = 200): Promise<Omit<DiscordAlertsClaimDto, 'battles' | 'rounds'>> {
    ...
    const claim: Omit<DiscordAlertsClaimDto, 'battles' | 'rounds'> = { turns: [], ranks: [], attacks: [], roundAlerts: [] };
