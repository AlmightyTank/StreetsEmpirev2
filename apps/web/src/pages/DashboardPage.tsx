          ...
          <div className="se-grid">
            <Panel title="Crew" flush>
              <div className="se-rows">
                ...
                <Row label="Thugs" value={formatNumber(me.resources.thugs)} strong tooltip="Only fit thugs can work, defend or raid. In 0.2.0-F, only armed fit thugs protect the street effectively." />
                ...
                <Row label="Armed / unarmed" value={`${formatNumber(me.resources.armedThugs)} / ${formatNumber(me.resources.unarmedThugs)}`} tooltip="Every fit thug wants a weapon. Unarmed thugs lower thug happiness and do not count as street cover in 0.2.0-F." />
