...
const developmentUpdates = [
  {
    ...
    body: 'The current development round now keeps production leaderboards for real players while local dev can still seed test rivals when needed. E also makes weapons and intel matter more: unarmed thugs take a bigger happiness hit, only armed fit thugs count as street cover when scouting, and rankings and profiles now show public money, rank streaks, past placements and achievements, while crew, weapons, exposed cash and crack stash still require recon. Successful E-round raids now roll a 5%-40% cut of exposed cash and crack, weighted low so the biggest hits are rare, and back-to-back hits on the same target pay less until you hit someone else. Player profiles also have a full achievement gallery with earned badges and locked progress across rank, wealth, combat, intel, reputation and legacy. Hover the new help markers to see what each number means.',
  },
  {
    id: 'dev-0.2.0-d',
