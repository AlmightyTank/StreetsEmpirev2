import type { BattleReportDto, CombatPageDto, CombatReconInputDto, CombatReconResultDto, CombatTreatmentDto, CombatTreatmentInputDto, DriveByInputDto, RaidInputDto } from '@streets/shared';
